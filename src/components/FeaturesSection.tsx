...
import { Bell, Calendar, Clock, Activity, Shield, Users } from 'lucide-react';
  ...
  const features = [
    {
      ...
      color: "bg-gradient-to-br from-medsync-purple-light to-medsync-purple-dark"
    },
    {
    ...
    },
    {
      ...
      description: "Track your vitals and medication effects over time with simple logging tools.",
      color: "bg-gradient-to-br from-medsync-teal to-medsync-blue"
    },
    {
      icon: <Shield size={24} className="text-white" />,
      title: "Privacy Focused",
      description: "Your health data stays on your device with optional encrypted backup.",
      color: "bg-gradient-to-br from-medsync-purple to-medsync-blue"
    },
    {
    ...
    },
    {
      ...
      description: "Manage medications for family members with separate profiles.",
      color: "bg-gradient-to-br from-medsync-purple-dark to-medsync-purple-light"
    }
  ];
